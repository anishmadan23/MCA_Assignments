...
if __name__ == '__main__':
    ...
    for idx in range(3):
        ...
        rf_sim_matrix = relevance_feedback(vec_docs, vec_queries, rf_sim_matrix)
        if args.verbose:
    ...
    for idx in range(3):
        if idx==0:
            rf_sim_matrix = sim_matrix
        rf_sim_matrix = relevance_feedback_exp(vec_docs, vec_queries, rf_sim_matrix, tfidf_model)
